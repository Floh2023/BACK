...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:1234@localhost:3306/db_new'
...
class Producto(db.Model):
    ...
    talle=db.Column(db.Integer,nullable=True)
    ...
    def __init__(self,nombre,precio,stock,talle,lote,fecha,imagen):   #crea el  constructor de la clase
...
def registro():
    ...
    nuevo_registro=Producto(nombre_recibido,precio,stock,talle,lote,fecha,imagen)
...
def productos():
    ...
    for objeto in all_registros:
        data_serializada.append({"id":objeto.id, "nombre":objeto.nombre, "precio":objeto.precio, "stock":objeto.stock, "talle":objeto.talle, "lote":objeto.lote, "fecha":objeto.fecha, "imagen":objeto.imagen})
...
def update(id):
    ...
    data_serializada = [{"id":producto.id, "nombre":producto.nombre, "precio":producto.precio, "stock":producto.stock, "talle":producto.talle, "lote":producto.lote, "fecha":producto.fecha, "imagen":producto.imagen}]
